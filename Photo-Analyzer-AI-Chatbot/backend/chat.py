...
from multimodal_chat import GalleryChat

router = APIRouter()

# Load chat.html content
with open("../frontend/templates/chat.html", "r") as f:
    chat_html = f.read()
...
async def read_root():
    """Serve the chat interface HTML page.
        ...
        This endpoint returns the pre-loaded HTML content for the chat interface.

        Returns:
            HTMLResponse: The contents of 'chat.html' as an HTML response.

        Notes:
            - The HTML file is loaded from '../frontend/templates/chat.html' at startup.
        """
    return chat_html
